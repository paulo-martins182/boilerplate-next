      ...
      actions: [
        ...
        (data) => {
          console.log(`
            ...
            git add src/components/${plop.getHelper('pascalCase')(data.name)}
            E então faça o commit:
            git commit -m "Adiciona componente ${plop.getHelper('pascalCase')(data.name)} com teste inicial quebrado"
          `);
